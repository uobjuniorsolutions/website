...
import 'package:je_website/widget/buttonHover.dart';
import 'package:je_website/widget/card.dart';
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              'We provide the digital services which you need to create and develop your businesss',
                              style: TextStyle(
                                color: Colors.black,
                                fontSize: 20,
                                fontWeight: FontWeight.w200,
                  ...
                  children: [
                    ...
                    Center(
                      child: Container(
                        width: size.width / 2,
                        child: Text(
                          'UoB Junior Solutions is a consulting firm that is run by University of Birmingham students. We provide digital solutions, data analytics and strategy services to individuals, small and medium companies, as well as institutions. Through the provision of these high quality services at competitive prices, we aim to aid and facilitate businesess in their development.',
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 20,
                            fontWeight: FontWeight.w200,
